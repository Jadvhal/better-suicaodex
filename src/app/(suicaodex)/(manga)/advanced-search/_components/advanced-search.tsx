...
export default function WeebdexAdvancedSearch() {
  ...
  const origLangList = [
    { value: "ja", label: "Japanese", icon: JP },
    { value: "zh", label: "Chinese", icon: CN },
  ...
  const sortList: { value: GetMangaSort; label: string }[] = [
    ...
    { value: "lastUploadedChapterAt", label: "Latest Chapter" },
    ...
    <>
      ...
      <section className="flex flex-col gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black uppercase">Advanced Search</h1>
        </div>
          ...
          >
            <div ref={contentRef}>
              ...
              >
                ...
                {/* Order */}
                <div className="flex flex-col gap-2">
                  <Label className="uppercase font-semibold">Order</Label>
                  <Select
                    key={`order-${resetKey}`}
                    value={selectedOrder ?? ""}
                    onValueChange={(v) =>
