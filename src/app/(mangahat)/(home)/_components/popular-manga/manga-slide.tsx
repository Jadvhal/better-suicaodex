...
import MangaCover from "@/app/(mangahat)/(manga)/manga/_components/manga-cover";
import { ContentRatingTag, NormalTag, StatusTag } from "@/app/(mangahat)/(manga)/manga/_components/manga-tags";
...
export default function MangaSlide({ manga }: MangaSlideProps) {
  ...
  const { text: translatedDesc } = useAutoTranslate(manga.description ?? "");
