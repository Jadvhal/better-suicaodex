      ...
      {!config.r18 && manga.content_rating === "pornographic" && (
        <AlertDialog defaultOpen>
          ...
          <AlertDialogContent className={`theme-${config.theme}`}>
            <AlertDialogHeader>
              <AlertDialogTitle>
                {t.manga.r18Confirm} <span className="text-red-600">{t.manga.r18Content}</span>{t.manga.r18AreYouSure}
              </AlertDialogTitle>
              <AlertDialogDescription>
                {t.manga.r18Description}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel asChild>
                <Link href="/">{t.manga.r18GoBack}</Link>
              </AlertDialogCancel>
              <AlertDialogAction
                onClick={() =>
                  setConfig({
          ...
          <div className="flex md:hidden flex-col gap-2 justify-between">
            <div className="flex flex-col gap-1.5">
              <p
                ...
                style={{
                  fontSize: `clamp(0.875rem, ${title.length <= 30
                    ? "7vw"
                    : title.length <= 50
                      ? "6vw"
                      : title.length <= 70
            ...
            <div className="flex flex-col justify-between h-54 pb-2">
              <div className="flex flex-col">
                <p
                  ...
                  style={{
                    fontSize: `clamp(2.25rem, ${title.length <= 20
                      ? "5vw"
                      : title.length <= 35
                        ? "4.2vw"
                        : title.length <= 50
