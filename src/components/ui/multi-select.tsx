      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit dark:bg-input/30 dark:hover:bg-input/50 [&_svg]:pointer-events-auto",
              className
            )}
          >
